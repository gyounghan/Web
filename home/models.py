...
class Photo(models.Model):
    image = models.ImageField(upload_to = user_path, null=True) # 어디로 업로드 할지 지정
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE,null=True) # 로그인 한 사용자, many to one relation
